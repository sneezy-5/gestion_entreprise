...
const options = controlledComputed(() => vuetifyTheme.name.value, () => {
  ...
  return {
    ...
    xaxis: {
      categories: ['Janvier', 'Fevrier', 'Mars', 'Avril','Mais','Juin','Juillet','Août','Septembre','Octobre','Novembre','Decembre'],
      tickPlacement: 'on',
      labels: { show: false },
...
const series = reactive([{name: 'Sale',  data: []}])
 ...
 const updateTresorerie = () => {
  dashboardService.getSaleByYear(form.start_date, form.end_date)
    .then(res => {
  ...
  <VCard>
    ...
    <VCardText>
      ...
      <div class="d-flex align-center mb-3">
        ...
        <p>
          l'évolution de votre chiffre d'affaire de l'annee
        </p>
      </div>
