...
avanceService.getAvance(routeParam)
      .then(res => {
    form.id =res.data.id  
    form.RequestDate = res.data.RequestDate;
    form.amountRequested = res.data.amountRequested;
    form.paymentDate = res.data.paymentDate;
    form.paymentMethod = res.data.paymentMethod;
    form.ReimbursmentDate = res.data.ReimbursmentDate;
...
const submit = () => {
  ...
  avanceService.updateAvance(form)
      .then((res: any) => {
