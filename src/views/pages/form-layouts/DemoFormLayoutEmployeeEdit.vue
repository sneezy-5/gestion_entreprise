...
employeesService.getlEmploye(routeParam)
      .then(res => {
    form.id =res.data.id  
    ...
    form.nationality = res.data.nationality;
    form.pictureURL = res.data.pictureURL;
    form.CNPSnumber = res.data.CNPSnumber;
    form.CMUnumber = res.data.CMUnumber;
    form.street = res.data.street;
    form.neighborhood = res.data.neighborhood;
    form.city = res.data.city;
    form.country = res.data.country;
    form.maritalStatus = res.data.maritalStatus;
    form.numberOfDependents = res.data.numberOfDependents;
    form.NbrOfParts = res.data.NbrOfParts;
    form.hiringDate = res.data.hiringDate;
    form.seniority = res.data.seniority;
    form.currentPosition = res.data.currentPosition;
    form.exitDate = res.data.exitDate;
    form.phonenumbers = res.data.phonenumbers;
...
const submit = () => {
  ...
  employeesService.updateEmploye(form)
      .then((res: any) => {
